...
public class Week04StringBuilderListSetMapLab {
	...
	public static void main(String[] args) {
		...
		// Strings are immutable but SB is a mutable object
				...
				System.out.println(concatListElements(swapped));
	...
	public static List<String> search(List<String> list, String query) {
		...
		return results;
			...
			// Method 5:
	public static String concatListElements(List<String> strings) {
